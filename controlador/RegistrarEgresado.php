...
/**
 * Description of RegistrarEgresado
 *
 * @author KRLOS
 */
...
$result = $facade->RegistrarEgresado($codEgresado, $nomEgresado, $apeEgresado, $corEgresado, $tipoEgresado, $docEgresado, $proEgresado);

if ($result) {
    echo '<script>alert("Egresado Registrado!!") </script>';
